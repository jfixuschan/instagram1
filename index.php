...
<html lang="en">
  ...
  <body>
	...
	<!--<form action="update.php" method="GET">
		<input type="" name="texts">
		<input type="" name="img">
		<input type="" name="id">
		<button class="btn btn-primary">Изменить</button>
	</form>-->
	<p><a href="http://25urok/admin.php">Админ-панель</a></p>
		...
		<div class="row"> 
			...
			<div class="col-8 px-0 my-2"> 
				...
				<div class="mt-5 border rounded">   
					...
					<div class="col-12" style="height: 400px; background-image: url(<?php echo $stroka["img"]?>); background-size: 100% 100%"> 
						<!--картинка поста-->
					</div>
					<div class="col-12 py-2">  <!--текстовые элементы поста-->
						...
						<div>
							<p class="texts1">
								...
								<form action="update.php" method="GET">
									<input type="" name="texts" placeholder="texts" value="<?php echo $stroka["texts"]; ?>">
									<input type="hidden" name="id" placeholder="id" value="<?php echo $stroka["id"]; ?>">
									<input type="" name="img" placeholder="img" value="<?php echo $stroka["img"]; ?>">
